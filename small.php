...
<main id="MainContent">
    ...
    <section id="Page_Index" class=" hasWallpaper">
        ...
        <?php if ((isset($_GET["id"]) && is_numeric($_GET["id"]))) {
            ...
            $small_offerss = $db->prepare("SELECT tbl_header_offers.clm_id , tbl_header_offers.tbl_name , tbl_header_offers.clm_name , tbl_header_offers.clm_parent , tbl_header_offers.clm_status ,
            ...
            FROM tbl_small_offers {$query} 
            {$sort};");

            $small_offerss->execute(array($id,$id,$id));
                            ...
                            <article class="tile tile-onebyone">
                                <a href="<?php if($small_offer["clm_type"] == "link"){ echo $small_offer["clm_link"]; }else{ echo  "offer.php?id={$small_offer["clm_id"]}&o={$small_offer["tbl_name"]}&c={$small_offer["clm_parent"]}"; }?>" aria-label="<?php echo "{$small_offer['clm_name']}"; ?>">
                                    <div class="tile__inner">
                                        <?php if ($small_offer["clm_limited"] == "yes") {
                                            echo '<p class="tile__flag">Limited time only!</p>';
                                        } ?>
